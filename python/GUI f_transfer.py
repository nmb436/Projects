...
class FileTransfer:
    def __init__(self,master):
        ...
        self.button_source = ttk.Button(self.frame, text ='find directory', command = askSource).grid(row = 1, column = 1)
        ...
        self.button_destination = ttk.Button(self.frame, text ='find directory', command = askDestination).grid(row = 2, column = 1)
        ...
        self.button_go = ttk.Button(self.frame, text ='GO', command = file_transfer).grid(row = 4, column = 2)
